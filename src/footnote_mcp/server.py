        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "entailment_backend": {"type": "string", "description": "heuristic | auto | ollama | local_nli | openai", "default": "heuristic"},
                },
                "required": ["query"],
            },
        ),
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "backend": {"type": "string", "description": "auto | heuristic | ollama | local_nli | openai", "default": "auto"},
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "backend": {"type": "string", "description": "heuristic | auto | ollama | local_nli | openai", "default": "heuristic"},
                },
