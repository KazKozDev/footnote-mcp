...
export FOOTNOTE_EXTRACTION_DUMP="/private/tmp/claude-502/-Users-artemk-projects-llmflow-search/4f3a99df-d70d-44d7-bc22-45daa9c360f8/scratchpad/extraction-325.jsonl"
OUTPUT_DIR="benchmarks/results/diag-task325-extraction-2026-08-05"
mkdir -p "$OUTPUT_DIR"
.venv/bin/python benchmarks/run_search_benchmarks.py \
  --suites deepsearchqa --deepsearchqa-ids 325 \
